...
<tr>
    ...
    <p>
        <b>Висновок: на даній лабораторній роботі я дослідила мережі згідно моделі OSI за допомогою програми Packet Tracer. В результаті виконання лабораторної роботи, труднощів не виникло та вдалося виконати
